...
module nios2_qsys_mm_interconnect_0 (
	...
	wire   [24:0] epcs_epcs_control_port_agent_m0_address;                                     // epcs_epcs_control_port_agent:m0_address -> epcs_epcs_control_port_translator:uav_address
	...
	wire  [101:0] epcs_epcs_control_port_agent_rf_source_data;                                 // epcs_epcs_control_port_agent:rf_source_data -> epcs_epcs_control_port_agent_rsp_fifo:in_data
	...
	wire  [101:0] epcs_epcs_control_port_agent_rsp_fifo_out_data;                              // epcs_epcs_control_port_agent_rsp_fifo:out_data -> epcs_epcs_control_port_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> epcs_epcs_control_port_agent:cp_valid
	wire  [100:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> epcs_epcs_control_port_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // epcs_epcs_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> epcs_epcs_control_port_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> epcs_epcs_control_port_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> epcs_epcs_control_port_agent:cp_endofpacket
	...
	wire  [100:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> ram_s1_agent:cp_data
	...
	wire   [24:0] pio_key_s1_agent_m0_address;                                                 // pio_key_s1_agent:m0_address -> pio_key_s1_translator:uav_address
	...
	wire  [101:0] pio_key_s1_agent_rf_source_data;                                             // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] pio_key_s1_agent_rsp_fifo_out_data;                                          // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pio_key_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                       // pio_key_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> pio_key_s1_agent:cp_channel
	...
	wire  [100:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> pio_led_s1_agent:cp_data
	...
	wire          cmd_mux_007_src_valid;                                                       // cmd_mux_007:src_valid -> sdram47_s1_agent:cp_valid
	wire  [100:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> sdram47_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                       // sdram47_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> sdram47_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                               // cmd_mux_007:src_startofpacket -> sdram47_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                 // cmd_mux_007:src_endofpacket -> sdram47_s1_agent:cp_endofpacket
	...
	wire          epcs_epcs_control_port_agent_rp_valid;                                       // epcs_epcs_control_port_agent:rp_valid -> router_005:sink_valid
	wire  [100:0] epcs_epcs_control_port_agent_rp_data;                                        // epcs_epcs_control_port_agent:rp_data -> router_005:sink_data
	wire          epcs_epcs_control_port_agent_rp_ready;                                       // router_005:sink_ready -> epcs_epcs_control_port_agent:rp_ready
	wire          epcs_epcs_control_port_agent_rp_startofpacket;                               // epcs_epcs_control_port_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          epcs_epcs_control_port_agent_rp_endofpacket;                                 // epcs_epcs_control_port_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [100:0] ram_s1_agent_rp_data;                                                        // ram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [100:0] pio_key_s1_agent_rp_data;                                                    // pio_key_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [100:0] pio_led_s1_agent_rp_data;                                                    // pio_led_s1_agent:rp_data -> router_008:sink_data
	...
	wire          sdram47_s1_agent_rp_valid;                                                   // sdram47_s1_agent:rp_valid -> router_009:sink_valid
	wire  [100:0] sdram47_s1_agent_rp_data;                                                    // sdram47_s1_agent:rp_data -> router_009:sink_data
	wire          sdram47_s1_agent_rp_ready;                                                   // router_009:sink_ready -> sdram47_s1_agent:rp_ready
	wire          sdram47_s1_agent_rp_startofpacket;                                           // sdram47_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          sdram47_s1_agent_rp_endofpacket;                                             // sdram47_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [100:0] cmd_demux_001_src3_data;                                                     // cmd_demux_001:src3_data -> cmd_mux_007:sink1_data
	wire          cmd_demux_001_src3_ready;                                                    // cmd_mux_007:sink1_ready -> cmd_demux_001:src3_ready
	wire    [7:0] cmd_demux_001_src3_channel;                                                  // cmd_demux_001:src3_channel -> cmd_mux_007:sink1_channel
	...
	wire  [100:0] rsp_demux_007_src1_data;                                                     // rsp_demux_007:src1_data -> rsp_mux_001:sink3_data
	wire          rsp_demux_007_src1_ready;                                                    // rsp_mux_001:sink3_ready -> rsp_demux_007:src1_ready
	wire    [7:0] rsp_demux_007_src1_channel;                                                  // rsp_demux_007:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire          epcs_epcs_control_port_agent_rdata_fifo_src_valid;                           // epcs_epcs_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] epcs_epcs_control_port_agent_rdata_fifo_src_data;                            // epcs_epcs_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          epcs_epcs_control_port_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_003:in_0_ready -> epcs_epcs_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> epcs_epcs_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> epcs_epcs_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                           // epcs_epcs_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> epcs_epcs_control_port_agent:rdata_fifo_sink_error
	...
	wire          sdram47_s1_agent_rdata_fifo_src_valid;                                       // sdram47_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] sdram47_s1_agent_rdata_fifo_src_data;                                        // sdram47_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          sdram47_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_007:in_0_ready -> sdram47_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                           // avalon_st_adapter_007:out_0_valid -> sdram47_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                            // avalon_st_adapter_007:out_0_data -> sdram47_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                           // sdram47_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                           // avalon_st_adapter_007:out_0_error -> sdram47_s1_agent:rdata_fifo_sink_error
	...
	nios2_qsys_mm_interconnect_0_router_004 router_006 (
	...
	nios2_qsys_mm_interconnect_0_router_004 router_009 (
	...
	nios2_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset

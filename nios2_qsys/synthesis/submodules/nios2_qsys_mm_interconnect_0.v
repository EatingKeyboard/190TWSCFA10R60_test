...
module nios2_qsys_mm_interconnect_0 (
		...
		input  wire [23:0] nios2_data_master_address,                 //                 nios2_data_master.address
		...
		input  wire [23:0] nios2_instruction_master_address,          //          nios2_instruction_master.address
	...
	wire   [23:0] nios2_data_master_translator_avalon_universal_master_0_address;              // nios2_data_master_translator:uav_address -> nios2_data_master_agent:av_address
	...
	wire   [23:0] nios2_instruction_master_translator_avalon_universal_master_0_address;       // nios2_instruction_master_translator:uav_address -> nios2_instruction_master_agent:av_address
	...
	wire   [23:0] nios2_debug_mem_slave_agent_m0_address;                                      // nios2_debug_mem_slave_agent:m0_address -> nios2_debug_mem_slave_translator:uav_address
	...
	wire   [23:0] epcs_epcs_control_port_agent_m0_address;                                     // epcs_epcs_control_port_agent:m0_address -> epcs_epcs_control_port_translator:uav_address
	...
	wire  [100:0] epcs_epcs_control_port_agent_rf_source_data;                                 // epcs_epcs_control_port_agent:rf_source_data -> epcs_epcs_control_port_agent_rsp_fifo:in_data
	...
	wire  [100:0] epcs_epcs_control_port_agent_rsp_fifo_out_data;                              // epcs_epcs_control_port_agent_rsp_fifo:out_data -> epcs_epcs_control_port_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> epcs_epcs_control_port_agent:cp_data
	...
	wire   [23:0] ram_s1_agent_m0_address;                                                     // ram_s1_agent:m0_address -> ram_s1_translator:uav_address
	...
	wire  [100:0] ram_s1_agent_rf_source_data;                                                 // ram_s1_agent:rf_source_data -> ram_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] ram_s1_agent_rsp_fifo_out_data;                                              // ram_s1_agent_rsp_fifo:out_data -> ram_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> ram_s1_agent:cp_data
	...
	wire   [23:0] pio_key_s1_agent_m0_address;                                                 // pio_key_s1_agent:m0_address -> pio_key_s1_translator:uav_address
	...
	wire  [100:0] pio_key_s1_agent_rf_source_data;                                             // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] pio_key_s1_agent_rsp_fifo_out_data;                                          // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pio_key_s1_agent:cp_data
	...
	wire   [23:0] pio_led_s1_agent_m0_address;                                                 // pio_led_s1_agent:m0_address -> pio_led_s1_translator:uav_address
	...
	wire  [100:0] pio_led_s1_agent_rf_source_data;                                             // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] pio_led_s1_agent_rsp_fifo_out_data;                                          // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> pio_led_s1_agent:cp_data
	...
	wire   [23:0] sdram47_s1_agent_m0_address;                                                 // sdram47_s1_agent:m0_address -> sdram47_s1_translator:uav_address
	...
	wire  [100:0] sdram47_s1_agent_rf_source_data;                                             // sdram47_s1_agent:rf_source_data -> sdram47_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] sdram47_s1_agent_rsp_fifo_out_data;                                          // sdram47_s1_agent_rsp_fifo:out_data -> sdram47_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> sdram47_s1_agent:cp_data
	...
	wire   [99:0] epcs_epcs_control_port_agent_rp_data;                                        // epcs_epcs_control_port_agent:rp_data -> router_005:sink_data
	...
	wire   [99:0] ram_s1_agent_rp_data;                                                        // ram_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [99:0] pio_key_s1_agent_rp_data;                                                    // pio_key_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [99:0] pio_led_s1_agent_rp_data;                                                    // pio_led_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [99:0] sdram47_s1_agent_rp_data;                                                    // sdram47_s1_agent:rp_data -> router_009:sink_data
	...
	wire   [99:0] router_src_data;                                                             // router:src_data -> nios2_data_master_limiter:cmd_sink_data
	...
	wire   [99:0] nios2_data_master_limiter_cmd_src_data;                                      // nios2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire   [99:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_limiter:rsp_sink_data
	...
	wire   [99:0] nios2_data_master_limiter_rsp_src_data;                                      // nios2_data_master_limiter:rsp_src_data -> nios2_data_master_agent:rp_data
	...
	wire   [99:0] cmd_demux_001_src0_data;                                                     // cmd_demux_001:src0_data -> cmd_mux_002:sink1_data
	...
	wire   [99:0] cmd_demux_001_src2_data;                                                     // cmd_demux_001:src2_data -> cmd_mux_007:sink1_data
	...
	wire   [99:0] rsp_demux_002_src1_data;                                                     // rsp_demux_002:src1_data -> rsp_mux_001:sink0_data
	...
	wire   [99:0] rsp_demux_007_src1_data;                                                     // rsp_demux_007:src1_data -> rsp_mux_001:sink2_data
